...
//
//        HoidleDailyCountryDTO returnCountry = gameService.getOrSetCountry();
//
...
//        assertThrows(NoDrawResultException.class, () -> gameService.getOrSetCountry());
//    }
//
//    @Test
...
//        var result = gameService.checkGuessForClassic(guess);
...
//        );
//
//        List<Colors> result = gameService.checkGuessForClassic(guess);
//
...
//
//        assertThrows(CountryNotFoundException.class, () -> this.gameService.checkGuessForClassic(guess));
//
//        when(db.getHoi4CountryRepository().findByName("Japan")).thenReturn(hoi4Country);
//
//        assertThrows(CheckingGuessFailedException.class, () -> this.gameService.checkGuessForClassic(guess));
//    }
//}
